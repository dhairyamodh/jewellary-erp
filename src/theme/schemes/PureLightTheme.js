...
const colors = {
  ...
  shadows: {
    ...
    card: '0px 0px 2px rgba(159, 162, 191, 0.7)',
    cardSm: '0px 0px 2px rgba(159, 162, 191, 0.7)',
    cardLg:
      '0 5rem 14rem 0 rgb(255 255 255 / 20%), 0 0.8rem 2.3rem rgb(0 0 0 / 3%), 0 0.2rem 0.3rem rgb(0 0 0 / 15%)'
  },
  layout: {
    general: {
      bodyBg: '#f2f5f9'
